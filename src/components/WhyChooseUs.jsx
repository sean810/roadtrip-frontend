...
const WhyChooseUs = () => {
  ...
  useEffect(() => {
    ...
    const observer = new IntersectionObserver(
      ...
      {
        // Lower threshold so animation fires before user reaches the section,
        // preventing visible pop-in during scroll
        threshold: 0.1,
  ...
  return (
    ...
    >
      <div className="max-w-4xl mx-auto px-6">
        ...
        {/* Header — no will-change-transform */}
        <div
